function attachEvents() {
    ...
    function createStudentElement(student) {
      ...
      trElement.appendChild(creatRd(student.firstName));
      trElement.appendChild(creatRd(student.lastName));
      trElement.appendChild(creatRd(student.facultyNumber));
      trElement.appendChild(creatRd(student.grade));
